...
`;
export const TVS = styled(TVIcon)
`
	${serviceCommon}
`;
export const Taxi = styled(TaxiIcon)
`
	${serviceCommon}
`;
export const Medical = styled(MedicalIcon)
`
	${serviceCommon}
`;
...
`
	${serviceCommon}
`;
export const Cast = styled(CastIcon)
`
	${serviceCommon}
`;
...
`
	${serviceCommon}
`;
export const Trello = styled(TrelloIcon)
`
	${serviceCommon}
`;
...
`
	${serviceCommon}
`;
export const Smartphone = styled(SmartphoneIcon)
`
	${serviceCommon}
`;
